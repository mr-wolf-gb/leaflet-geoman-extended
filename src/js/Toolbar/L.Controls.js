...
const PMButton = L.Control.extend({
  ...
  _makeButton(button) {
    ...
    const contextMenuHandler = (e) => {
      ...
      // Show context menu
      if (this._map.pm.Toolbar._contextMenu) {
        this._map.pm.Toolbar._contextMenu.show(e, this, btnName);
      }
    };

    L.DomEvent.disableClickPropagation(buttonContainer);
    L.DomEvent.on(buttonContainer, 'contextmenu', L.DomEvent.stop);
    L.DomEvent.on(buttonContainer, 'contextmenu', contextMenuHandler, this);
