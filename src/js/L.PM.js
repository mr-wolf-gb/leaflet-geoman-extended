...
import Library from './Library/L.PM.Library';
...
import './Draw/L.PM.Draw.DistanceLine';
...
import './Draw/L.PM.Draw.Circle2Points';
import './Draw/L.PM.Draw.Circle3Points';
import './Draw/L.PM.Draw.Cut';
import './Draw/L.PM.Draw.Text';
import './Draw/L.PM.Draw.DangerousGoodsZones';
...
import './Edit/L.PM.Edit.DangerousGoodsZones';
...
L.PM = L.PM || {
  ...
  addInitHooks() {
    ...
    function initLayerGroup() {
      ...
      if (L.PM.optIn) {
        if (this.options.pmIgnore === false) {
          if (this._dangerousGoodsZones) {
            this.pm = new L.PM.Edit.DangerousGoodsZones(this);
          } else {
  ...
  reInitLayer(layer) {
    ...
    if (layer.pm) {
      ...
      if (layer._dangerousGoodsZones) {
        layer.pm = new L.PM.Edit.DangerousGoodsZones(layer);
      } else {
