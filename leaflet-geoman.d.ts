...
declare module 'leaflet' {
  ...
  interface Evented {
    ...
    /******************************************
     *
     * TODO: EXPORT/IMPORT EVENTS ON MAP ONLY
     *
     ********************************************/

    /** Fired when layers are exported as GeoJSON. */
    on(type: 'pm:export', fn: PM.ExportEventHandler): this;
    once(type: 'pm:export', fn: PM.ExportEventHandler): this;
    off(type: 'pm:export', fn?: PM.ExportEventHandler): this;

    /** Fired when GeoJSON is imported. */
    on(type: 'pm:import', fn: PM.ImportEventHandler): this;
    once(type: 'pm:import', fn: PM.ImportEventHandler): this;
    off(type: 'pm:import', fn?: PM.ImportEventHandler): this;
  }
  ...
  namespace PM {
    ...
    interface PMMap
      ...
      /** Returns true if keyboard shortcuts are currently enabled. */
      keyboardShortcutsEnabled(): boolean;

      /**
       * Export all Geoman layers as GeoJSON.
       * @param options Export options
       * @param options.onlyDrawn If true, exports only layers drawn by Geoman
       * @returns GeoJSON FeatureCollection
       */
      exportGeoJSON(options?: { onlyDrawn?: boolean }): GeoJSON.FeatureCollection;

      /**
       * Import GeoJSON and add layers to the map.
       * @param geojson GeoJSON object to import
       * @param options Import options
       * @param options.clearExisting If true, clears existing Geoman layers before import
       * @param options.markAsDrawn If true, marks imported layers as drawn by Geoman
       * @param options.layerOptions Leaflet layer options to apply to imported layers
       * @returns Array of imported layers
       */
      importGeoJSON(
    ...
    interface GlobalOptions extends DrawModeOptions, EditModeOptions {
      ...
      /** Library options. ⭐*/
      library?: {
        /** Enable or disable the library feature. Default: false */
        enabled?: boolean;
        /** Categories JSON data */
        json?: object;
        /** URL to load categories JSON from */
        url?: string;
        /** Auto-load library data on initialization. Default: true */
        autoLoad?: boolean;
        /** Panel position on the map. Default: 'topright' */
        panelPosition?: 'topleft' | 'topright' | 'bottomleft' | 'bottomright';
        /** URL loading options */
        urlOptions?: {
          cache?: boolean;
          timeout?: number;
    ...
    interface DrawModeOptions extends SnappingOptions {
      ...
      /** Freehand-specific options. Use `fill: true` for polygon, `fill: false` for line (default: { fill: false }) ⭐ */
      freehandOptions?: {
        /** If true, creates a polygon; if false, creates a line (default: false) */
        fill?: boolean;
      };
    ...
    interface ToolbarOptions {
      ...
      /** Adds button to draw Arrow (default:true) */
      drawArrow?: boolean;
      ...
      /** Adds button to draw Circle with 2 Points (default:true) */
      drawCircle2Points?: boolean;

      /** Adds button to draw Circle with 3 Points (default:true) */
      drawCircle3Points?: boolean;
     ...
     */
    export type ExportEventHandler = (e: {
     ...
     */
    export type ImportEventHandler = (e: {
      geojson: GeoJSON.GeoJsonObject;
      layers: L.Layer[];
      clearExisting: boolean;
    }) => void;
